"use client";
import { AudioObjectType } from "@/types/portfolio";

const audioObjects: AudioObjectType[] = [
    {
        src: '/audio/portfolio/slowedreverb.mp3',
        title: 'cochise - tell em (feat. $not)',
        link: 'https://www.youtube.com/watch?v=SBrpkDZ5Luk&t=0s'
    },
    {
        src: '/audio/portfolio/brokenheart.mp3',
        title: 'Lord Lorenz - BROKEN HEART 4 U',
        link: 'https://www.youtube.com/watch?v=2eMWFHVG7fM'
    },
    {
        src: '/audio/portfolio/backgroundmusic.mp3',
        title: 'Unknown - bgmusic',
        link: '#'
    },
    {
        src: '/audio/portfolio/boneheads.mp3',
